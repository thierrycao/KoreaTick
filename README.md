...
- 港股：`HKEX:07709`、`HKEX:07747`、`HKEX:00992`
- A 股：`SZSE:002463`、`SZSE:300394`、`SSE:600396`、`SSE:600726`、`SSE:601991`、`SSE:603986`、`SSE:688008`

港股和 A 股不再使用新浪。页面可选择数据源：同花顺优先（默认）、富途牛牛优先、东方财富、腾讯行情。当前同花顺公开接口可稳定获取 A 股；港股同花顺公开接口不可用时会按顺序回退到富途牛牛、东方财富、腾讯行情，并在卡片/详情中标出实际使用的数据源。详情页会显示每日涨跌幅。
